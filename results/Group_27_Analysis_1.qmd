...
1.  Demographic factors (Base group: Management positions not shown)
...
2.  Education level (Baseline:PhD)
...
3.  Marital status Marital_Status(Base group: Single or Not married)

    Married 2.626701 p\<2e-16 \*\*\* Married people are 13.8 times more likely to have a high income than the baseline group (OR=exp(2.626)=13.8)
...
4.  Occupation type (Base group: Management)
    ...
    *White-Collar: Coefficient-2.845193 P =0.000904.* It‘s more likely to earn a high income.

    OccupationWhite-Collar 1.134498 p=0.000199

    Blue-Collar: Coefficient –0.155595, p = 0.622942. It not significantly indicates no clear income difference from the baseline group after adjusting for other factors.
